...
class WebsitesControllerTest < ActionController::TestCase
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post :create, website: { address: @website.address, description: @website.description, name: @website.name, sudo_address: @website.sudo_address }
    end
  ...
  test "should update website" do
    patch :update, id: @website, website: { address: @website.address, description: @website.description, name: @website.name, sudo_address: @website.sudo_address }
    assert_redirected_to website_path(assigns(:website))
  end
